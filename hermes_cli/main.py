...
def _apply_profile_override() -> None:
    ...
    # 2. If no flag, check active_profile in the hermes root — unless a
    # supervisor-launched gateway child is running (fixed identity per slot,
    # #74872; see _under_gateway_supervisor), or this is a desktop SSH backend
    # session (upstream guard added after our fork point — must be preserved).
